...
public class EmployeeController {
	...
	@GetMapping("/status")
	public GenericResponse<Boolean> modeOfWorkUpdate(Principal principal) throws Exception{
		GenericResponse<Boolean> genericResponse = new GenericResponse<>(this.employeeService.modeOfWorkUpdate(principal.getName()),null);
		return genericResponse;
	}
