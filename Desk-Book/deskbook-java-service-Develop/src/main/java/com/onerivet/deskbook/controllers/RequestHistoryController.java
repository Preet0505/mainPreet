...
public class RequestHistoryController {
    ...
    @GetMapping("/request-history/search/{name}")
     public GenericResponse<List<RequestHistoryDto>> getAllbyFirstNameandLastName(@PathVariable("name") Principal principal, String name,PaginationAndSorting sorting) {
